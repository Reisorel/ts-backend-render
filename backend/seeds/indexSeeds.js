...
var treeSeeds_1 = require("./treeSeeds");
var runSeeds = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent(); // Connexion à MongoDB
                console.log("📡 Connected to MongoDB");
                return [4 /*yield*/, (0, treeSeeds_1.default)()];
            case 2:
                _a.sent(); // Exécute les seeds pour les arbres
                console.log("🌱 Seeds executed successfully");
                return [3 /*break*/, 5];
            case 3:
                error_1 = _a.sent();
                console.error("❌ Error executing seeds:", error_1);
                return [3 /*break*/, 5];
            case 4:
