...
var treeSeeds = function () { return __awaiter(void 0, void 0, void 0, function () {
    var trees;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, tree_1.default.deleteMany()];
            case 1:
                _a.sent(); // Supprime tous les projets existants
                trees = [
                    {
                        name: "Chêne",
                ...
                return [4 /*yield*/, tree_1.default.insertMany(trees)];
            case 2:
                _a.sent();
                console.log("\uD83C\uDF33 ".concat(trees.length, " trees added sucessfully !"));
                return [2 /*return*/];
        }
    });
}); };
